...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Surgical Tool Detection Training Script.',
    ...
    parser.add_argument('--num-lands', help='The number of landmarks', type=int, default=2)
    ...
    parser.add_argument('--unet-img-dim', help='Dimension to adjust input images to before inputting into U-Net', type=int, default=512)
    ...
    loss_fig_file = output_path + "/loss_fig.png"
    ...
    train_ds = SurgicalToolRandomDataAugDataSet(train_data_path, train_data_num, proj_pad_dim=proj_unet_dim, ds_factor=ds_factor, num_classes=num_classes, data_aug=data_aug, heavy_aug=heavy_aug)
    ...
    valid_ds = SurgicalToolRandomDataAugDataSet(valid_data_path, valid_data_num, proj_pad_dim=proj_unet_dim, ds_factor=ds_factor, num_classes=num_classes, data_aug=data_aug, heavy_aug=heavy_aug, valid=True)
