...
if __name__ == '__main__':
        parser = argparse.ArgumentParser(description='5 Fold Sim2Real Testing for Surgical Tool Detection Task.',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)

        parser.add_argument('root_fold_path', help='Path to the root 5-fold folder', type=str)

        parser.add_argument('checkpoint_filename', help='Trained checkpoint file path', type=str)
        ...
        if vit_name.find('R50') != -1:
                ...
                int(img_size / vit_patches_size), int(img_size / vit_patches_size))  # args.img_size
        ...
        for fold_ID in range(1, 6):
                ...
                output_folder = FOLD_PATH + "/output/sim2real_network_detection"
