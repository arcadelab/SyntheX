...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hip Imaging Training Script for Controlled Study.',
    ...
    parser.add_argument('label_file_path', help='Path to datafile containing segmentations and landmarks', type=str)
    ...
    parser.add_argument('--checkpoint-freq', help='Frequency (in terms of epochs) at which to save the network checkpoint to disk.', type=int, default=10)
    ...
    train_ds = get_dataset(data_file_path, label_file_path, train_pats, num_classes=num_classes,
    ...
    if train_valid_split < 0:
        ...
        valid_ds = get_dataset(data_file_path, label_file_path, valid_pats, num_classes=num_classes,
